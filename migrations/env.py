...
# same env var that redirects the app also redirects migrations.
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        # SQLite can't ALTER/DROP columns directly; batch mode has Alembic
        # recreate the table under the hood instead.
        context.configure(
